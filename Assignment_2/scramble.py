...
EOF in the assignment description, though I see now that's kinda just the whole point of using stdin in the first place)

- Abridged some comments for better readability

- Simplified that the "Shuffle the word" step per feedback
